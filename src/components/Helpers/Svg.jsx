export function HeartSvg() {
    return (
        <svg width="2em" height="3em" viewBox="0 0 24 24" className="heart-svg"  >
            <path
...
export function CartSvg() {
    return (
        <svg width="1.8em" height="3em" viewBox="0 0 24 24" className="cart-svg" fill="gray">
            <path
...
export function SortSvg() {
    return (
        <svg width="3em" height="5em" viewBox="0 0 24 24">
            <path
...
export function AnimatedHeartSvg() {
    return (
        <svg
            width="64em"
            height="20em"
